...
class _AddStudentState extends State<AddStudent> {
  ...
  String getClassFieldName(String className) {
    final normalized = className.replaceAll(' Class', '').trim();

    final classMapping = {
      'anganwadi': 'Anganwadi',
      'mini anganwadi': 'MiniAnganwadi',
      '1st': 'FirstClass',
      'first': 'FirstClass',
      '2nd': 'SecondClass',
      'second': 'SecondClass',
    ...
    return classMapping[normalized.toLowerCase()] ??
        'FirstClass'; // Default fallback
  }
  ...
  Future<void> _submitForm() async {
    ...
    final classFieldName = getClassFieldName(widget.className);
    _logger.i("Selected 'classified' Class: $classFieldName");
    final Map<String, dynamic> data = {
      ...
      "className": classFieldName, // Send as "FirstClass", "SecondClass", etc.
  ...
  void initState() {
    super.initState();
    _logger.i("className in screen Add Student..${widget.className}");
    _logger.i("schoolId in screen Add Student..${widget.schoolId}");
    _logger.i("schoolName in screen Add Student..${widget.schoolName}");
    _logger.i("talukaName in screen Add Student..${widget.talukaName}");
    _logger.i("talukaId in screen Add Student..${widget.talukaId}");
    _logger.i("districtName in screen Add Student..${widget.districtName}");
    debugPrint("${widget.districtId}");
    debugPrint("${widget.gramPanchayatName}");
    debugPrint("${widget.gramPanchayatId}");
  }
