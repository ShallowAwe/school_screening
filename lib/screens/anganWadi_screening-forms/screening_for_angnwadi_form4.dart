...
class _ScreeningForAngnwadiClassFormFourState
  ...
  void initState() {
    super.initState();
    print("Anganwadi Form 4 - Category: Diseases (categoryId: 3)");
    fetchDiseaseCategory(); // 3 = Diseases
    fetchHospitals();
  }
  ...
  Map<String, dynamic> _buildOutputData() {
    ...
    print('📋 Form 4 - Detected Diseases: $detectedDiseases');
