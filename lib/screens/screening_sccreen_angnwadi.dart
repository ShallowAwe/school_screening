...
class _ScreenningSchoolScreenState extends State<ScreenningAngnwadiScreen> {
  ...
  Future<SchoolDetails?> fetchSchoolDetails(int schoolId) async {
    final url = Uri.parse(
      "https://NewAPIS.rbsknagpur.in/api/Rbsk/GetAllSchoolDataWithSchoolId?schoolId=$schoolId",
    );
    try {
      ...
      if (response.statusCode == 200) {
        ...
        if (decoded is Map<String, dynamic>) {
          if (decoded['success'] == true && decoded['school'] != null) {
    ...
    try {
      ...
      if (response.statusCode == 200) {
        ...
        if (decoded is List) {
          ...
          _logger.e('❌ Error fetching schools: ${response.body}');
        ...
        _logger.e('❌ Error fetching schools: ${response.body}');
        _logger.i('SchoolsUrl: $uri');
        throw Exception('Failed: ${response.statusCode}');
      }
    } catch (e) {
      _logger.e('❌ Error fetching schools: $e');
      // _logger.i('error body: ${response.body}');
      // _logger.d('SchoolsUrl: $uri');
      setState(() {
        isLoadingSchools = false;
          ...
          children: [
            ...
            GestureDetector(
              onTap: () {
                ...
                _logger.d('Selected class: $selectedClass');
