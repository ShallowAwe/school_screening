...
class _StudentInfoScreenState extends State<StudentInfoScreen> {
  ...
  Widget _buildStudentCard(BuildContext context, Map<String, dynamic> student) {
    // Check if student has been screened
    final bool isScreened = student['isScreened'] == true;
    ...
    return Container(
      ...
      decoration: BoxDecoration(
        ...
        borderRadius: BorderRadius.circular(12),
        border: Border.all(
          color: isScreened ? Colors.green : const Color(0xFFE0E0E0),
          width: isScreened ? 2 : 1,
        ),
        boxShadow: [
          BoxShadow(
      ...
      child: Opacity(
        ...
        child: Material(
          ...
          child: InkWell(
            ...
            onTap: isScreened
                ? () {
                    // Show message that student is already screened
                    ScaffoldMessenger.of(context).showSnackBar(
                      SnackBar(
                        content: Row(
                          children: const [
                            ...
                            SizedBox(width: 12),
                            Text('This student has already been screened'),
                          ],
                        ),
                      ...
                      Navigator.of(context).push(
                        MaterialPageRoute(
                          builder: (context) => ScreeningFormScreenOne(
                            ...
                            aadhaarNo: student['aadhaarNumber'],
